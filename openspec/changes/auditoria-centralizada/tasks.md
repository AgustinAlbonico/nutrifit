...
- [ ] 3.3 ID: `AUD-014`; files: `apps/frontend/src/pages/AdminAuditoriaPage.tsx`; description: adapt filters and CSV/JSON export actions; depends-on: AUD-013.
- [ ] 3.4 ID: `AUD-015`; files: `openspec/changes/auditoria-centralizada/tasks.md`; description: verify manually with existing typecheck/build and API/UI QA only; depends-on: AUD-014.
