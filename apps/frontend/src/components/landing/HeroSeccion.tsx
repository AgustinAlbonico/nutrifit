    ...
    >
      ...
      <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-12 px-6 lg:grid-cols-12 lg:gap-8 lg:px-10">
        <div className="flex flex-col justify-center lg:col-span-7">
          <div className="landing-reveal landing-delay-1 mb-6">
            <Badge
              variant="outline"
              className="border-landing-lima/40 bg-landing-lima-soft text-landing-lima backdrop-blur-sm"
            >
          ...
          <h1 className="landing-reveal landing-delay-2 font-display text-[2.75rem] font-bold leading-[1.05] tracking-tight text-landing-cream sm:text-6xl lg:text-[4.5rem]">
            ...
            <span className="relative whitespace-nowrap text-landing-lima">
              máquinas
              <svg
          ...
          <div className="landing-reveal landing-delay-4 mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a href="#contacto">
              <Button
                size="lg"
                className="group w-full bg-landing-lima text-landing-ink hover:bg-landing-lima-bright sm:w-auto"
              >
          ...
          <div className="landing-reveal landing-delay-5 mt-12 flex items-center gap-6 text-sm text-landing-cream/50">
            <div className="flex items-center gap-2">
              <TrendingUp className="h-4 w-4 text-landing-lima" />
        ...
        <div className="landing-reveal landing-delay-3 relative flex items-center justify-center lg:col-span-5">
          <div className="relative w-full max-w-md">
            <div className="absolute -inset-4 rounded-3xl bg-landing-lima/10 blur-2xl" aria-hidden />
            <div className="relative rounded-2xl border border-landing-line-dark bg-landing-ink-soft/80 p-6 backdrop-blur-md landing-glow-lima">
              <div className="mb-5 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="h-2.5 w-2.5 rounded-full bg-landing-lima" />
              ...
              <div className="space-y-3">
                {[
                  ...
                  >
                    <div className="flex h-10 w-10 flex-col items-center justify-center rounded-md bg-landing-lima-soft">
                      <span className="font-display text-xs font-bold text-landing-lima">
                        {turno.hora.split(':')[0]}
                      </span>
                      <span className="text-[10px] text-landing-lima/70">
                        {turno.hora.split(':')[1]}
                      </span>
                    </div>
                    ...
                    <span className="rounded-full bg-landing-lima-soft px-2 py-0.5 text-[10px] font-medium text-landing-lima">
                      {turno.estado}
                    </span>
                  </div>
                ))}
              ...
              <div className="mt-5 flex items-center justify-between border-t border-landing-line-dark pt-4">
                ...
                <span className="font-display text-sm font-bold text-landing-lima">87%</span>
              </div>
              <div className="mt-2 h-1.5 w-full overflow-hidden rounded-full bg-landing-ink">
                <div className="h-full w-[87%] rounded-full bg-gradient-to-r from-landing-lima-deep to-landing-lima" />
              </div>
            </div>
          </div>
        </div>
