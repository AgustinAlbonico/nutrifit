      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 font-display text-4xl font-bold leading-tight tracking-tight text-landing-ink sm:text-5xl lg:text-[3.5rem]">
            ...
            <br />
            <span className="text-landing-naranja-deep">Crecemos con tu gimnasio.</span>
          </h2>
        ...
        <div className="mx-auto mt-16 max-w-5xl">
          <div className="relative overflow-hidden rounded-3xl border border-landing-ink bg-landing-ink text-landing-cream landing-glow-naranja">
            ...
            <div className="grid grid-cols-1 gap-0 lg:grid-cols-5">
              <div className="p-8 lg:col-span-2 lg:p-10">
                <div className="inline-flex items-center gap-2 rounded-full bg-landing-naranja-soft px-3 py-1 text-xs font-semibold uppercase tracking-wide text-landing-naranja">
                  Plan base
                </div>
                <h3 className="mt-5 font-display text-3xl font-bold leading-tight">
                  Suscripción mensual
                  <br />
                  <span className="text-landing-naranja">por sede activa</span>
                </h3>
                ...
                <div className="mt-8 flex items-baseline gap-2">
                  ...
                  <span className="font-display text-5xl font-bold tracking-tight text-landing-naranja">
                    USD
                  </span>
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
                  <Button
                    ...
                    className="group bg-landing-naranja text-landing-ink hover:bg-landing-naranja-bright"
                  >
                    Comenzar ahora
                  ...
                  <a
                    href="#contacto"
                    className="text-sm text-landing-cream/60 underline-offset-2 underline decoration-landing-cream/30 hover:text-landing-cream/90 hover:decoration-landing-cream/60 transition-colors"
                  >
                    Hablar con ventas
                  </a>
                </div>
                ...
                <ul className="mt-5 grid grid-cols-1 gap-x-6 gap-y-3 sm:grid-cols-2">
                  {INCLUYE_PLAN_BASE.map((item) => (
                    <li key={item} className="flex items-start gap-2.5 text-sm text-landing-cream/80">
                      <Check className="mt-0.5 h-4 w-4 flex-shrink-0 text-landing-naranja" strokeWidth={2.5} />
                      {item}
                    </li>
                  ))}
                </ul>
        ...
        <div className="mx-auto mt-16 max-w-4xl border-l-2 border-landing-naranja-deep pl-6">
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            {COMPLEMENTOS.map((comp) => (
              <article
                key={comp.titulo}
                className="landing-card-hover group flex flex-col rounded-2xl border border-landing-line bg-landing-cream p-7 hover:border-landing-naranja-deep/40 hover:shadow-lg"
              >
                <div className="flex items-start justify-between">
                  <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-landing-naranja-soft text-landing-naranja-deep transition-colors group-hover:bg-landing-naranja group-hover:text-landing-ink">
                ...
                <ul className="mt-4 space-y-1.5 border-t border-landing-line pt-4">
                  {comp.items.map((item) => (
                    <li key={item} className="flex items-center gap-2 text-sm text-landing-ink/70">
                      <span className="h-1 w-1 rounded-full bg-landing-naranja-deep" />
                      {item}
                    </li>
                  ))}
                </ul>
