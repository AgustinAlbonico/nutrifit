      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 font-display text-4xl font-bold leading-tight tracking-tight text-landing-cream sm:text-5xl lg:text-[3.5rem]">
            Una plataforma.
            <br />
            <span className="text-landing-lima">Cinco experiencias.</span>
          </h2>
        ...
        <div className="mt-16 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {ROLES.map((rol) => (
            <article
              key={rol.nombre}
              className="landing-card-hover group relative flex flex-col rounded-2xl border border-landing-line-dark bg-landing-ink-soft/50 p-7 hover:border-landing-lima/40 hover:bg-landing-ink-soft"
            >
              <div className="flex items-center justify-between">
                <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-landing-lima-soft text-landing-lima transition-colors group-hover:bg-landing-lima group-hover:text-landing-ink">
        ...
        <div className="mt-12 flex flex-wrap items-center gap-3 rounded-xl border border-landing-line-dark bg-landing-ink-soft/40 px-6 py-5">
          <Shield className="h-5 w-5 text-landing-lima" strokeWidth={1.75} />
