...
export abstract class UsuarioRepository implements BaseRepository<UsuarioEntity> {
  ...
  abstract findAdminByGimnasioId(gimnasioId: number): Promise<UsuarioEntity | null>;
