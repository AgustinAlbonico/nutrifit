...
exports.ALIMENTOS_BASE_ARGENTINA = void 0;
exports.normalizarNombreAlimento = normalizarNombreAlimento;
exports.limpiarNombreAlimento = limpiarNombreAlimento;
exports.esNombreRuidoso = esNombreRuidoso;
exports.mapearProductoOpenFoodFacts = mapearProductoOpenFoodFacts;
const UnidadMedida_1 = require("../../domain/entities/Alimento/UnidadMedida");
exports.ALIMENTOS_BASE_ARGENTINA = [
    {
        nombre: 'Leche entera',
        cantidad: 100,
        calorias: 61,
        ...
        carbohidratos: 5,
        grasas: 3,
        unidadMedida: UnidadMedida_1.UnidadMedida.MILILITRO,
    },
    {
        ...
        carbohidratos: 5,
        grasas: 3,
        unidadMedida: UnidadMedida_1.UnidadMedida.GRAMO,
    },
    {
        nombre: 'Huevo',
        cantidad: 100,
...
function normalizarNombreAlimento(nombre) {
    return nombre
        .normalize('NFD')
        .replace(/[\u0300-\u036f]/g, '')
...
function limpiarNombreAlimento(nombre) {
...
function esNombreRuidoso(nombre) {
...
function resolverCantidadYUnidad(cantidadCruda) {
    if (!cantidadCruda) {
        return { cantidad: 100, unidadMedida: UnidadMedida_1.UnidadMedida.GRAMO };
    }
    ...
    if (unidadRaw === 'kg') {
        ...
        return {
            ...
            unidadMedida: UnidadMedida_1.UnidadMedida.KILOGRAMO,
        };
    }
    if (unidadRaw === 'l' ||
        unidadRaw === 'lt' ||
        ...
        return { cantidad: Math.round(valorRaw), unidadMedida: UnidadMedida_1.UnidadMedida.LITRO };
    }
    if (unidadRaw === 'ml') {
        return {
            cantidad: Math.round(valorRaw),
    ...
    return { cantidad: Math.round(valorRaw), unidadMedida: UnidadMedida_1.UnidadMedida.GRAMO };
}
...
//# sourceMappingURL=alimentos-argentina-catalogo.util.js.map