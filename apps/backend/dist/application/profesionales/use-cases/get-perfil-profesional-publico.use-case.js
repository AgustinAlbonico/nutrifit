...
exports.GetPerfilProfesionalPublicoUseCase = void 0;
...
let GetPerfilProfesionalPublicoUseCase = class GetPerfilProfesionalPublicoUseCase {
    ...
    async execute(id) {
        ...
        if (!nutricionista || nutricionista.fechaBaja) {
            throw new custom_exceptions_1.NotFoundError('Profesional', String(id));
        }
        this.logger.log(`Perfil publico consultado para profesional ${id}.`);
        const response = new dtos_1.PerfilProfesionalPublicoResponseDto();
        ...
        response.horarios = (nutricionista.agendas ?? []).map((agenda) => {
            const horario = new dtos_1.HorarioProfesionalPublicoDto();
...
exports.GetPerfilProfesionalPublicoUseCase = GetPerfilProfesionalPublicoUseCase;
exports.GetPerfilProfesionalPublicoUseCase = GetPerfilProfesionalPublicoUseCase = __decorate([
...
//# sourceMappingURL=get-perfil-profesional-publico.use-case.js.map