...
exports.DesbloquearTurnoUseCase = void 0;
...
let DesbloquearTurnoUseCase = class DesbloquearTurnoUseCase {
    turnoRepository;
    logger;
    ...
    async execute(nutricionistaId, turnoId) {
        ...
        this.logger.log(`Turno ${turnoId} desbloqueado por profesional ${nutricionistaId}.`);
...
exports.DesbloquearTurnoUseCase = DesbloquearTurnoUseCase;
exports.DesbloquearTurnoUseCase = DesbloquearTurnoUseCase = __decorate([
...
//# sourceMappingURL=desbloquear-turno.use-case.js.map