...
- Name: flujos\crear-turno-staff.spec.ts >> Flujo: Crear turno por staff >> socio ve acceso denegado en /turnos/nuevo
- Location: e2e\flujos\crear-turno-staff.spec.ts:98:7
...
Locator: getByText(/Acceso denegado/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Acceso denegado/i)
