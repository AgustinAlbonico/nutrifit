...
- Name: flujos\crear-turno-staff.spec.ts >> Flujo: Crear turno por staff >> recepción puede crear turno para socio sin ficha y ve warning + confirmación
- Location: e2e\flujos\crear-turno-staff.spec.ts:46:7
...
Locator: getByRole('heading', { name: /Asignar turno a un socio/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /Asignar turno a un socio/i })
